...
public class OwleryConfig extends ObservedJAXBEntity {
	...
	public static final String ID_COLUMN_HEAD = "ID";
	public static final String TITLE_COLUMN_HEAD = "Title";
	public static final String OWL_NAME_COLUMN_HEAD = "Owl Name";
	public static final String MODULE_COLUMN_HEAD = "Module";
	public static final String DATE_COLUMN_HEAD = "Date";
	...
	private final ObjectProperty<SelectedShowBy> selectedShowBy = new SimpleObjectProperty<>(SelectedShowBy.OWL_NAME);
	...
	public List<Object> getProperties() {
		return Arrays.asList(idColumnVisible, titleColumnVisible, owlNameColumnVisible, moduleColumnVisible, dateColumnVisible, selectedShowBy, editOwlPreview, editPreviewDividerPos, groupDividerPos);
	}
